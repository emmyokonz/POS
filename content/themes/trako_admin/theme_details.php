<?php
	...
	class Theme_default_admin
	{
		...
		/* 
		 ...
		 supported language.
		*/
		public $name = 'Trakonet Admin Theme';

		/*
		  The description of your theme.  
		 */
		public $description = 'The default admin theme for Trakonet';

		// The author of the theme.
		public $author = 'Trakonet Applications';

		// the author's email address
		public $author_email = 'info@trakonet.com';
