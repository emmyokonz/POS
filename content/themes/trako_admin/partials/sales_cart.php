...
<div class="row">
	<div class="col-sm-12">
		...
		<div class="row">
					...
					<label class="control-label" for="item"> <?=lang('sales_product_label') ?>
						...
						<div class="row">
							...
							<input name="item" id="item" placeholder="<?=lang('sales_add_product_desc') ?>" class="form-control" />
								<input type="hidden" id="cart_name" name="cart" value="sales_cart"/>
							</div>
							...
							<table class="table table-condensed table-hover">
								<thead>
									<tr>
										...
										<th width="50px"><span class="fa fa-spinner text-danger fa-spin loader hidden"></span></th>
									</tr>
								</thead>
			...
			<div class="col-sm-3">
				<?php echo  form_open(site_url('ajax/add_cart_people'),['id'=>"add_people_form", "class"=>"people-form"]) ?>
					...
					<input class="form-control" value="<?=set_value('name', $cart_content['people']['name'],true) ?>" name="name" id="people" data-people="1"  />
					<input type="hidden" id="cart_name" name="cart" value="sales_cart"/>
					</div>
				<?=form_close()?>
				<div class="panel">
		...
		<div class="text-uppercase">
			<a href="<?=site_url('sales/save') ?>" class="btn btn-info btn-sm save-cart savenew">
				<span class="fa fa-check"></span>
				<span class="hidden-xs hidden-sm"><?=lang('btn_save') ?></span></a>

			<a href="<?=site_url('sales/save') ?>" type="submit" class="btn btn-info btn-sm save-cart saveclose">
			...
			<a href="<?=site_url(previous_url('sales',true)) ?>" class="cancle btn btn-default btn-sm">
