...
<h3 class="box-title clearfix">
	...
	<div class="pull-right">
		<a href="<?=site_url('sales/save') ?>" class="btn btn-info btn-sm edit-cart savenew">
			<span class="fa fa-check"></span>
			<span class="hidden-xs hidden-sm"><?=lang('btn_save') ?></span></a>

		<a href="<?=site_url('sales/save') ?>" type="submit" class="btn btn-info btn-sm edit-cart saveclose">
