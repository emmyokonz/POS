...
<h3 class="box-title clearfix">
	...
	<div class="pull-right">
		<a href="javascript:void(0);" data-backdrop="static" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#recipients" data-agenttype="2" data-whatever="<?=lang('contact_choose_file') ?>">
			<span class="fa fa-paperclip"></span>
			<span class="hidden-xs hidden-sm"><?=lang('btn_recipients_file') ?></span></a>
		...
		<button type="submit" class="btn btn-info btn-sm" name="submit" value="saveClose">
